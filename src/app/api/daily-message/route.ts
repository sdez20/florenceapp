...
Ground it in what is real for her today: her cycle phase (given below if known), her current focus${
    focus ? ` (${focus})` : ""
  }, and what you know about her from her profile. Make it specific to her real phase, focus, and life — never generic wellness wallpaper, never a line like "stay hydrated" or "take a deep breath" that could be sent to anyone.
